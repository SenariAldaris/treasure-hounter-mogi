...
$(document).ready(function() {
    function uploadSuccess(file, serverData) {
		...
		if(response == 'hacking'){
			...
			$('<span id="photo_'+response[0]+'"></span>').appendTo('#photos').html('<div class="hralbum" style="margin:0px;background:#efefef;"></div><div id="cover_'+response[0]+'" class="covers" style="padding-bottom:1px;padding-top:10px;padding-left:10px;"><a href="/photo'+response[2]+'_'+response[0]+'_sec=loaded" onClick="Photo.Show(this.href); return false"><div class="albums_cover"><div class="albums_cover_delswq"><a href="/" onClick="AlbumDeletePhoto(\''+response[0]+'\'); return false;"><img class="icon del_photo_ic" src="/templates/Old/images/spacer.gif" alt="" /><div></div></a></div><span id="count_img"><img src="'+response[1]+'" alt="" /></span></div></a><a href="/" onClick="SetNewCover(\''+response[0]+'\'); return false;" id="cover_link_'+response[0]+'" class="cover_links"><div class="alb_cover_scw">'+lang_albums_set_cover+'</div></a><div style="float:left;"><div class="albums_opis" style="color:#888;padding-bottom:5px;"><b>'+lang_albums_add_photo+'</b></div><textarea class="inpst-loads" id="descr_'+response[0]+'" style="width:280px;height:90px;"></textarea><div class="clear"></div></div><a href="/" onClick="PhotoSaveDescr(\''+response[0]+'\'); return false;"><div class="bit_saves_photos">'+lang_albums_save_descr+'</div></a><div class="clear"></div></div>');
    ...
    var swfu = new SWFUpload({
		...
		flash_url: "/templates/Old/js/swfupload.swf",
		...
		button_image_url: "/templates/Old/images/uploadbuttona.png",
		button_width: 145,
		button_height: 24,
...
<div class="clear_topsrt" style=" margin-top: -14px;"></div>
<div class="box_right_owne" style="margin-top: -14px;">
 ...
 <div class="activetab news_a"><a href="/albums/add/{aid}" onClick="Page.Go(this.href); return false;"><div>Добавление фотографий</div></a></div>
</div>
<div class="clear"></div>
<div class="load_photo_quotes">Поддерживаемые форматы файлов:  JPG, PNG и GIF.</div>
<div class="h1_load_photos" id="l_textsw" style="display:none;">Загруженные фотографии</div>
<span id="photos"></span>
<div class="clear"></div>
<div class="load_photo_but" style="margin-left:148px;">
<div class="fl_l">
