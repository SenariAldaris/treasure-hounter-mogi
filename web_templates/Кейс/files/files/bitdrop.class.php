...
class BitDrop
{
	...
	{			
		...
		{
		    $this->errorMessage = "this file has been flagged";
		    return false;
		}
		
		if($data['deleted'] or !file_exists("../uploads/{$data['fid']}.temp"))
		{
			$this->errorMessage = "this file has been deleted";
			return false;
		}
		...
		{
			$this->errorMessage = "this file has expired";
			return false;
		}
		...
		{
			$this->errorMessage = "max downloads reached";
			return false;
		}
