    (function (global) {
     ...
     /* :-1: */ thumbsdown: /:\-1:/g
            ...
            var defaultConfig = {
                ...
                only_crawl_id: null,
                img_dir: '/templates/Old/images/emoji',
                ignored_tags: {
                    'SCRIPT': 1,
                    'TEXTAREA': 1,
                    'A': 1,
            ...
            function insertEmojicon(node, match, emojiName) {
				...
				emojiImg.setAttribute('style', 'width:20px;height:20px');
            ...
            function defaultReplacer(emoji, name) {
                return "<img title=':" + name + ":' alt=':" + name + ":' class='emoji' src='" + defaultConfig.img_dir + '/' + name + ".png' align='absmiddle' style='width:20px;height:20px' />";
            }
