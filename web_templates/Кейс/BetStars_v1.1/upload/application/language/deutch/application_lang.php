...
$lang['bf_home_intro'] = 'Welcome to <span class="text-blue">Bet Stars</span>. This is a tipster <span class="text-blue">Competition</span> site. Create an account now and compete for our montly competition <span class="text-blue">Rewards</span>.';
//------------------------------------------------------------------------------
// ! GENERAL SETTINGS
//------------------------------------------------------------------------------
...
$lang['bf_language'] = 'Site Language';
$lang['bf_language_help'] = 'Choose the default site language.';

$lang['bf_date'] = 'Date';
$lang['bf_time'] = 'Time';
$lang['bf_total_users'] = 'Total Users';
$lang['bf_total_tips'] = 'Total Tips';

$lang['bf_demo_mode'] = 'Sorry :) not allowed in DEMO mode';

$lang['bf_bs_version'] = 'App Version';
$lang['bf_bs_current_version'] = 'Current Version';
$lang['bf_bs_latest_version'] = 'Latest Version';

$lang['bf_bs_version_up_to_date'] = 'Latest Version is Installed';
$lang['bf_bs_available'] = 'Available';
$lang['bf_bs_get_updates'] = 'Get Updates';

$lang['bf_last_db_update'] = 'Last Database Update';
//------------------------------------------------------------------------------
// ! AUTH SETTINGS
//------------------------------------------------------------------------------
...
$lang['bf_remember_time'] = 'Remember For';
$lang['bf_week'] = 'Week';
$lang['bf_weeks'] = 'Weeks';
$lang['bf_days'] = 'Days';
...
$lang['bf_register']     = 'Open Registrations?';
$lang['bf_remember']     = 'Remember?';
...
$lang['bf_password_force_numbers'] = 'Force numbers?';
$lang['bf_password_force_symbols'] = 'Force symbols?';
$lang['bf_password_force_mixed_case'] = 'Force mixed case?';
$lang['bf_password_show_labels'] = 'Display validation labels';
...
$lang['bf_email'] = 'Email';
$lang['bf_view_profile'] = 'My Profile';
$lang['bf_edit_profile'] = 'Edit Profile';
$lang['bf_admin_dashboard'] = 'Control Panel';
$lang['bf_view_site'] = 'VIEW SITE';
$lang['bf_post_tip'] = 'Post New Tip';
$lang['bf_select_state'] = 'Select State';
$lang['bf_select_no_state'] = 'No State Available';
$lang['bf_new_tip'] = 'NEW TIP';
$lang['bf_login'] = 'Log In';
//------------------------------------------------------------------------------
// !
//------------------------------------------------------------------------------
$lang['bf_both'] = 'both';
...
$lang['bf_new'] = 'New';
$lang['bf_list'] = 'List';
$lang['bf_active'] = 'Active';
$lang['bf_inactive'] = 'Inactive';
...
$lang['bf_login_activate_email'] = '<b>Have an activation code?</b> Activate your membership on the [ACCOUNT_ACTIVATE_URL] page.<br />    <b>Need your code again?</b> Request it again on the [ACTIVATE_RESEND_URL] page.';
...
$lang['bf_menu_home'] = 'Home';
$lang['bf_menu_tips'] = 'Tips';
$lang['bf_menu_tipsters'] = 'Tipsters';
$lang['bf_menu_competitions'] = 'Competitions';
$lang['bf_menu_bookmakers'] = 'Bookmakers';
$lang['bf_menu_events'] = 'Events';
$lang['bf_menu_scores'] = 'Livescores';
$lang['bf_menu_news'] = 'News';
//------------------------------------------------------------------------------
