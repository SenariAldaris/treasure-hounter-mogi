...
<input type="text" class="videos_input" style="width:484px" maxlength="140" id="title_n" />
...
<iframe frameborder="no" src="#" id="text" name="text" class="videos_input wysiwyg_inpt" style="margin:0px;padding:0px;width:495px"></iframe>
<div class="clear"></div>
<div class="html_checkbox swryuikjhgfds" style="text-shadow:none;" id="mywall" style="margin-top:10px;margin-bottom:10px;color:#555" onClick="myhtml.checkbox(this.id);">Опубликовать на моей стене</div>
<div class="clear"></div>
