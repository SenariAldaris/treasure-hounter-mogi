...
class Settings extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->auth->restrict('Translate.View');
        $this->auth->restrict('Translate.Manage');

		$language = $this->input->cookie('language');
		$this->lang->load('translate',$language);
            ...
            if (isset($_POST['save'])) {
				...
				{				
					...
					if (save_lang_file($langFile, $transLang, $_POST['lang'])) {
						...
						redirect(SITE_AREA . "/settings/translate/index/{$transLang}");
					}
    ...
    public function do_export($language = null, $includeCore = false, $includeCustom = false)
    {
        ...
        $this->zip->download("bet_stars_{$language}_files.zip");
        die();
    }
}
