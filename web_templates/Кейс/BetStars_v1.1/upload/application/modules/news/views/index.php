...
<div class="box">
	...
	<div class="box-header pbn bg-white">
		<h4 class="head text-left pl20 fs14"><?php echo lang('news_latest_football_news'); ?>
			<div class="box-tools pull-right">
				<?php echo lang('news_espn_feeds'); ?>
				<a href="http://espn.go.com/espn/news/story?page=rssinfo">
				<img class="img-responsive ml10 mr10 mt5 fr h24"src="<?php echo base_url();?>assets/img/espn_dotcom_black.gif">
				</a>
			</div>
		</h4>
	</div>	
				...
				<?php
					...
					<li class="list-group-item">
						...
						<?php echo form_open(base_url('news/article') . '/' .$post, 'id="form" class="form-horisontal"'); ?>
							...
							<p class="text-blue"><?php echo $age; ?></p>
