...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
   <tr>
    <td align="center" class="m-tb"><a style='color:white;' href='/account/pm/'>Написать</a></td>
    ...
    <td align="center" class="m-tb"><a style='color:white;' href='/account/pm/referals/'>Рассылка рефам</a></td>
  </tr>
</table>
...
<br />
<input type="submit" name="sendd" value="Отправить сообщение" class="btn_8"/>
</form>
...
<input type="submit" value="Ответить" class="btn_9">
...
<td align='center'>
<form action="" method="post"><input type="hidden" name="id_in" value="<?=$in['id']; ?>"><input type="submit" name="outbox" value="Просмотр" class="btn_9"></form><br>

<form action="" method="post"><input type="hidden" name="id_dell_in" value="<?=$in['id']; ?>"><input type="hidden" name="del" value="yes"><input type="submit" name="outbox" value="Удалить" class="btn_9"></form>
</td>
</tr>
				...
				if($ref_data['all_users'] !=0) {
					...
					$con = mysql_connect($config->HostDB, $config->UserDB, $config->PassDB);
						...
						//	echo $cena_ref;
							...
							echo '<center><font color="#914A1F">Сообщения отправлены </font></center>';
...
Стоимость отправки 1 сообщение 1 рефералу - 25 сер.
</font></center>
...
<br />
<input type="submit" name="send" value="Разослать" class="btn_8"/>
</form>
</td></tr>
			...
			if(!empty($theme)) {
				if(!empty($text)) {
					if($cena <= $user_data['money_b']) {
						...
						$db->Query("UPDATE ".$pref."_users_b SET money_b = money_b - '$cena' WHERE id = '$usid'");
						echo '<center><font color="#914A1F">Ваше сообщение отправлено пользователю '.$login_in.'</font></center>';
...
<center><font color="red">
Стоимость отправки сообщения - 10 сер.
</font></center>
...
<textarea name="message" rows="5" cols="40"></textarea>
<br />
<input type="submit" name="send" value="Отправить" class="btn_8"/>
</form>
</td></tr>
