...
if (! function_exists('form_dropdown_custom')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function form_dropdown_custom ($data, $options = array(), $selected = array(), $label = '', $extra = '', $tooltip = '')
    {
        if (! is_array($data)) {
            $data = array('name' => $data);
        }
...
if (! function_exists('form_dropdown_custom2')) {
    /**
     * Returns a properly templated dropdown field.
     *
     * @param string $data    The element name or an array of key/value pairs of
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function form_dropdown_custom2 ($data, $options = array(), $selected = array(), $label = '', $extra = '', $tooltip = '')
    {
        if (! is_array($data)) {
            $data = array('name' => $data);
        }
        ...
        return "
<div class='form-group{$error}'>
    <label class='col-sm-4 control-label' for='{$data['id']}'>{$label}</label>
    <div class='col-sm-7'>
         <select {$output} {$extra}>
            {$options_vals}
        </select>
