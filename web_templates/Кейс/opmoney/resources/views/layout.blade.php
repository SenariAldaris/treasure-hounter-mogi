...
<head>
    <meta charset="utf-8"/>
    <title>RU-SKRIPT.RU  - Только победа!</title>
    <meta name="description" content="RU-SKRIPT.RU  - Только победа!"/>
    <meta name="keywords" content="RU-SKRIPT.RU ,открытие кейсов,призовые кейсы,дропы,кейсы"/>
    <base href="/"/>
...
<div class="wrapper">
    <header class="header">
        <div class="inner">
            <div class="logo"><a href="/"><img src="/uploads/logo.png" alt="STOREGAMER.RU "></a>
            </div>
            <div class="stat">
    ...
    <footer class="footer">
        <div class="inner">
            <div class="l">
                <div class="copy">
                    Copyright &copy; 2016 STOREGAMER.RU !. Все права защищены.<br>Авторизуясь на сайте вы принимаете <a
                            href='/pages/terms'>пользовательское соглашение</a><br>
                </div>
            </div>
            <div class="r">
                <h5>Принимаем</h5>
        ...
        <div class="popup-container">
            ...
            <div class="amount-l">
                <form name="form-deposit" id="form-deposit" method="post" action="https://sci.interkassa.com/" enctype="utf-8">
                  ...
                  <input type="hidden" name="ik_desc" value="Пополнение на сайте STOREGAMER.RU " />
...
<!--[if IE]></div><![endif]--><a class="vk-button" href="RU-SKRIPT.RU" rel="nofollow" target="_blank"><span
            class="flaticon-soc-vk"></span> Мы в вк RU-SKRIPT.RU !</a>
</body>
</html>
