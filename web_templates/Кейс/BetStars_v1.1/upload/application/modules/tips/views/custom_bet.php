		...
		<div class="box-body">	
			...
			<div class="tab-content">		
				...
				<div class="tab-pane active fade in" id="bet_detail">
					...
					<h4>
						<img class="h24 mtm2 mrm5" src="<?php echo base_url();?>uploads/sports/<?php e($this->sports_model->get_sport_icon_by_id($sport_id)); ?>"/>
						<img class="h24 mtm2" src="<?php echo base_url();?>uploads/countries/<?php e($this->countries_model->get_country_flag_by_id($country_id)); ?>"/>
									
						<span class="text-blue fs12 mr20"><?php e(strtoupper($league_name)); ?></span>
						...
						<span class="pull-right fs12 hidden-xs"><?php echo lang('tips_action_before_post');?>
					...
					<?php if ( $tips_open ) { ?>
						...
						<?php echo form_open($this->uri->uri_string(), 'id="form" class="form-horisontal"'); ?>
							...
							<div class="form-group text-center">
								...
								<img class="h30 mtm2 mr10" src="<?php echo base_url();?>uploads/teams/<?php e($this->teams_model->get_team_logo_by_name($away_team,$league_id)); ?>"/>
					...
					<ul class="nav nav-tabs mb15">
						<li class="active">
							<a href="#head-to-head" data-toggle="tab" aria-expanded="true">
								...
								<?php echo lang('tips_head_to_head'); ?>
							</a>
						</li>
						<li class="">
							...
							<div class="table-responsive">
								<table id="events_table" class="table table-striped" role="grid">
									...
									<tbody>
										...
										<tr>
											<td class="text-left text-red pl50"><?php echo lang('bet_events_no_results'); ?></td>
											<td></td>
											<td></td>
											<td></td>
											<td></td>
							...
							<div class="table-responsive">
								...
								<table id="events_table" class="table table-striped" role="grid">
									...
									<tbody>	
										...
										<tr class="">
											<td class="text-left text-red pl50"><?php echo lang('bet_events_no_upcoming_events'); ?></td>
											<td></td>
											<td></td>
											<td></td>
											<td></td>
