...
<script type="text/javascript">
	$('#speedbar').show();
	$('#speedbar').text(lang_setings_blacks_list);
</script> <div class="box_right_owne" style=" margin-top: -12PX;">
  ...
  <div class="activetab news_a"><a href="/settings/blacklist" onClick="Page.Go(this.href); return false;"><div><b>Черный список</b></div></a></div>
...
[yes-users]<div class="allbar_title_settings" style="margin-bottom: 12px;">В Вашем черном списке находится {cnt}</div>[/yes-users]