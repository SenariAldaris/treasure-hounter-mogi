...
<div class="buttonsprofile albumsbuttonsprofile" style="height:10px">
 <div class="activetab_gifts"><a href="/messages" onClick="Page.Go(this.href); return false;"><div>Полученные</div></a></div>
...
<div class="buttonsprofile albumsbuttonsprofile" style="height:10px">
 ...
 <div class="activetab_gifts"><a href="/messages/outbox" onClick="Page.Go(this.href); return false;"><div>Отправленные</div></a></div>
</div>
<div class="clear"></div><div style="margin-top:10px;"></div>
...
[review]<div class="buttonsprofile albumsbuttonsprofile" style="height:10px">
 <a href="/messages" onClick="Page.Go(this.href); return false;">Полученные</a>
 <a href="/messages/outbox" onClick="Page.Go(this.href); return false;">Отправленные</a>
 <div class="activetab_gifts"><a href="/" onClick="Page.Go('/messages/show/{mid}'); return false"><div>Просмотр сообщения</div></a></div>
</div>
