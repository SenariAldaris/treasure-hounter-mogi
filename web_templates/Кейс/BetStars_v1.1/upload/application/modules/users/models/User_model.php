...
class User_model extends MY_Model
{
    ...
    protected $validation_rules = array(
        ...
        array(
            'field' => 'country',
            'label' => 'lang:us_country',
            'rules' => 'required|trim|max_length[3]|is_numeric',
        ),	
        array(
            'field' => 'about_me',
            'label' => 'lang:us_about_me',
            'rules' => 'trim|max_length[255]',
        ),			
        array(
            'field' => 'paypal_account',
            'label' => 'lang:us_paypal_account',
            'rules' => 'trim|max_length[255]',
        ),	
        array(
            'field' => 'skrill_account',
            'label' => 'lang:us_skrill_account',
            'rules' => 'trim|max_length[255]',
        ),			
        array(
            'field' => 'username',
    ...
    protected $field_info = array(
		...
		array('name' => 'country'),
		array('name' => 'about_me'),
		array('name' => 'paypal_account'),
		array('name' => 'skrill_account'),
        array('name' => 'active'),
    ...
    public function prep_data($post_data)
    {
        ...
        if (! empty($post_data['display_name'])) {
            $data['display_name'] = $post_data['display_name'];
        }
