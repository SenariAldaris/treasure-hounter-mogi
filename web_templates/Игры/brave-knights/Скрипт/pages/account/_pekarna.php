...
<center>
Чтобы построить пекарню необходимо запастись необходимыми строительными материалами, которые можно купить в лавке. В булочной вы будете печь хлеб и поставлять его в главную столовую под реализацию.</center>
</br>
</br>
...
$db->Query("INSERT INTO db_stats_pbar (user_id, user, bar, date_add, date_del) VALUES ('$usid','$usname','Хлеб','".time()."','".(time()+60*60*24*15)."')");
$da = time();
$dd = $da + 60*60*24;
# загружаем
...
<div class="fr-te-gr-title"><b>Пекарня</b></div> 
...
Для приготовления 100 булок:<br />
Нужно - 100 кг. муки<br />
...
<form action="" method="post">
Приготовление... <br />
<center><img src="/img/fruit/hleb.png" width="80" height="60" /><br />Хлеб: 100шт.<br /></center> 
<?PHP		
if ($fact["active"] < 0) { ?>  <center><input type="submit" class="btn_8" name="sbor5" value="Собрать" /></center>
