<div class="s-bk-lf">
	<div class="acc-title3">Описание проекта</div>
</div>
...
<?PHP
	...
	if(isset($_POST["tx"])){
	$_POST["tx"] = $db->RealEscape($_POST['tx']);
		$db->Query("UPDATE ".$pref."_conabrul SET about = '".$_POST["tx"]."' WHERE id = '1'");
		echo "<center><font color = '#914A1F'><b>Сохранено</b></font></center><BR />";
	}

$db->Query("SELECT * FROM ".$pref."_conabrul WHERE id = '1'");
$data = $db->FetchArray();
?>
