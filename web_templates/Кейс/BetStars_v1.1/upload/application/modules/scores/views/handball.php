...
<div class="box">
	<div class="box-header bg-white">
		...
		<h4 class="head text-left pl20 fs14">
			<img class="h30 mtm1" src="<?php echo base_url();?>uploads/sports/<?php e($this->sports_model->get_sport_icon_by_id(9)); ?>"/>
			<?php echo lang('bet_events_handball_scores'); ?>
					...
					<tbody>		
						...
						<tr>
							...
							<td class="w200">
								...
								<span class="text-blue"><?php echo $date->plaintext; ?></span>
								<?php endforeach ;?>
							</td>							
							<td class="w200">
								<?php foreach ($tr->find('td.td2') as $status):?>
								<span class=""><?php echo $status->plaintext;?></span>
								<?php endforeach ;?>
							</td>	
