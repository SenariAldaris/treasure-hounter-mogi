 ...
 *
 * Allows management of the Roles.
 *
 * @package		Roles
 * @subpackage	Roles
 * @author		codauris
...
class Settings extends Admin_Controller
{
    ...
    private $permissionCreate = 'Roles.Add';
    private $permissionEdit = 'Roles.Manage';
    private $permissionView = 'Roles.View';
