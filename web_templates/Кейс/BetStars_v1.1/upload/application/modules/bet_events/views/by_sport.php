...
$sport_name = $this->sports_model->get_sport_name_by_id($sport_id);?>
	<div class="box">
		<div class="box-header bg-white pbn">
			...
			<img class="h30 mtm2" src="<?php echo base_url();?>uploads/sports/<?php e($this->sports_model->get_sport_icon_by_id($sport_id)); ?>"/>
		...
		<div class="box-body ptn">	
			<div class="table-responsive">
					...
					<?php 
						...
						$leagues = $this->bet_events_model->get_live_leagues_by_sport_id($sport_id);
