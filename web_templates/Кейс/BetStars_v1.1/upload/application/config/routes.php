...
Route::any('events', 'bet_events');
Route::any('events/by_sport/(:any)', 'bet_events/by_sport/$1');
Route::any('events/by_league/(:any)', 'bet_events/by_league/$1');
// Authentication
...
Route::any('tipsters/edit_profile', 'users/edit_profile');
