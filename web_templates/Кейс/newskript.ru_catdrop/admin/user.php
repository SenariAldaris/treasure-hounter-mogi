...
if(!empty($_GET['id'])){
		...
		while($drop = $items->fetch_object()){
			...
			$itemsBlock .= '<span class="item-incase '.$item->type.'" target="_blank" style="text-decoration: none;">
									...
									<div class="picture">
										...
										<a href="http://catdrop.net/case/'.$case->name.'"><img class="picture-case" src="/admin/images/'.$case->picture.'"></a>
									</div>
									<div class="descr">
    ...
    while($drop = $items->fetch_object()){
        ...
        $itemsBlock .= '<span class="item-incase '.$item->type.'" target="_blank" style="text-decoration: none;">
								...
								<div class="picture">
									<a href="http://catdrop.net/case/'.$item->name.'"><img class="picture-item" src="'.$item->image.'/110fx82f" alt="Дроп">
