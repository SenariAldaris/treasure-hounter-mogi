			...
			<div class="head-content">
				...
				<div class="navbar-collapse pull-left collapse" id="navbar-collapse" aria-expanded="false" style="height: 1px;">
					<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
						...
						<li <?php echo check_class('results'); ?>><a href="<?php echo base_url();?>results"><?php echo lang('bf_menu_results');?></a></li>
					</ul>
				</div><!-- /.navbar-collapse -->
        ...
        <div class="container-fluid">
			...
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				...
				<?php else:?>
					<a href="<?php echo site_url('login'); ?>" class="fr btn btn-clean"><?php e(lang('bf_login')); ?></a>				
				<?php endif;?>
			  </ol>
