...
<div class="box_right_owne" style="position: absolute;margin-top: -8px;  background: none repeat scroll 0 0 rgba(0, 0, 0, 0); border-left: 5px solid rgba(0, 0, 0, 0);">
 ...
 <div class="news_text">Меню</div>
  <div class="activetab news_a"><a href="?act=add" onClick="Page.Go(this.href); return false">Добавить новость</a></div>
...
<input type="text" class="videos_input" style="width:500px" maxlength="65" id="title" />
